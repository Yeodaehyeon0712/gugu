...
public class EffectManager : TSingletonMono<EffectManager>
{
    ...
    #region Spawn Method
    public async UniTask<BaseEffect> SpawnEffect(long index, Vector3 position,Transform parent=null) => await effectFactory.SpawnObjectAsync(eEffectType.Effect, index, position,parent);
